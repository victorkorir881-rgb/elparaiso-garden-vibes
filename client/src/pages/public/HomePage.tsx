          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {features.map((f, i) => (
              <ScrollReveal key={f.title} animation="fade-up" delay={i * 100}>
                <div className="bg-card border border-border rounded-xl p-6 card-hover text-center h-full">
      ...
      <section className="section-padding bg-card/50">
        <div className="container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {[{ label: "Dine-In", icon: Utensils },{ label: "Delivery", icon: Truck },{ label: "Takeaway", icon: Utensils },{ label: "Drive-Through", icon: Car },{ label: "Reservations", icon: Users }].map((s, i) => (
              <ScrollReveal key={s.label} animation="scale" delay={i * 100}>
                <div className="bg-card border border-border rounded-xl p-5 text-center"><s.icon className="w-8 h-8 text-primary mx-auto mb-3" /><div className="text-sm font-medium text-foreground">{s.label}</div></div>
              </ScrollReveal>
            ))}
          </div>
        </div>
          ...
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {testimonials.slice(0, 6).map((t, i) => (
                <ScrollReveal key={t.id} animation="fade-up" delay={i * 100}>
          ...
          <div className="container">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
              {gallery.slice(0, 8).map((img, i) => (
                <ScrollReveal key={img.id} animation="scale" delay={i * 80}>
          ...
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              {events.slice(0, 3).map((evt, i) => (
                <ScrollReveal key={evt.id} animation="fade-up" delay={i * 120}>
                  <div className="bg-card border border-border rounded-xl overflow-hidden card-hover h-full">

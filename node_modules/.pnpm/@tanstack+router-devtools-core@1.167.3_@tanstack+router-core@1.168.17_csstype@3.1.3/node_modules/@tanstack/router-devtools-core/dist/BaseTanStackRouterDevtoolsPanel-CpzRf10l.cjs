...
var BaseTanStackRouterDevtoolsPanel = function BaseTanStackRouterDevtoolsPanel({ ...props }) {
	...
	if ("subscribe" in router().stores.pendingMatches) {
		const [_pendingMatches, setPending] = require_context.createSignal([]);
		pendingMatches = _pendingMatches;
		const [_cachedMatches, setCached] = require_context.createSignal([]);
...
//# sourceMappingURL=BaseTanStackRouterDevtoolsPanel-CpzRf10l.cjs.map
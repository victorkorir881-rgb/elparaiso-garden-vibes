        ...
        <div className="relative z-10 container text-center py-24">
          ...
          <ScrollReveal animation="fade-up" delay={600}>
            <div className="flex flex-wrap gap-3 justify-center mb-10">
              <Link to="/menu"><Button size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90 font-semibold px-8">View Menu</Button></Link>
          ...
          <div className="container">
            <ScrollReveal>
              <div className="flex items-end justify-between mb-10">
                ...
                <Link to="/menu" className="text-primary hover:text-primary/80 text-sm font-medium flex items-center gap-1 transition-colors">Full Menu <ChevronRight className="w-4 h-4" /></Link>
              </div>
            </ScrollReveal>
          ...
          <div className="container">
            <ScrollReveal>
              <div className="flex items-end justify-between mb-8">
                ...
                <Link to="/gallery" className="text-primary hover:text-primary/80 text-sm font-medium flex items-center gap-1 transition-colors">View All <ChevronRight className="w-4 h-4" /></Link>
              </div>
            </ScrollReveal>
          ...
          <div className="container">
            <ScrollReveal>
              <div className="flex items-end justify-between mb-8">
                ...
                <Link to="/events" className="text-primary hover:text-primary/80 text-sm font-medium flex items-center gap-1 transition-colors">All Events <ChevronRight className="w-4 h-4" /></Link>
              </div>
            </ScrollReveal>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
